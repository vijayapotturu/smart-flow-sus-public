...
- [app/AI-Document-Review-lluppesms.bicep](./infra/app/AI-Document-Review-lluppesms.bicep) - Azure Container Apps resources to host the 'AI-Document-Review-lluppesms' service.
