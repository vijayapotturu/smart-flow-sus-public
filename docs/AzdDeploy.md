...
If a project is configured to use azd, then these commands and notes apply.
...
Typically a developer will either do the up command to do everything at once, or do the provision and deploy commands separately.
